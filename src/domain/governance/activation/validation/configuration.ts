...
import type { ActivationConfiguration, ActivationConfigurationBinding, PhaseId } from '../types.js';
...
export function validateActivationConfigurationBinding(value: unknown): ActivationConfigurationBinding {
