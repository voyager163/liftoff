...
import type { ActivationIdentity, ApprovalEnvelope, ApprovalGateKind, GovernanceScope, PhaseId } from '../types.js';
...
export function validateApprovalResource(value: unknown, path: string): ApprovalEnvelope['resources'][number] {
...
export function validateApprovalDestination(value: unknown, path: string): ApprovalEnvelope['destinations'][number] {
...
export function identityMatches(left: ActivationIdentity, right: ActivationIdentity): boolean {
