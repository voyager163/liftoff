...
import type { EvidenceReference, ExternalOperationState, LiveReadbackProvider, PhaseId, PhaseState, PhaseOutputBindings, GovernanceTaskProjectionContract, GovernanceTaskProjectionRecord, UserActivationState } from '../types.js';
...
export function validateExternalOperation(value: unknown, path: string): ExternalOperationState {
...
export function validateOutputBindings(value: unknown, path: string): PhaseOutputBindings {
...
export function validateEvidenceReference(value: unknown, path: string): EvidenceReference {
...
export function validateUserActivationState(value: unknown): UserActivationState {
  ...
  let remoteBinding: UserActivationState['remoteBinding'];
