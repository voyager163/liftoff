...
describe('infrastructure layout contract', () => {
  it.each(['0.11.0', '0.11.1', '0.11.2', '0.11.3', '0.12.0', '0.12.1', '0.12.2', '0.12.3'])('recognizes complete independent roots generated by %s', (version) => {
    const identities = [
      ...sharedApplicationModuleIdentities,
  ...
  it('accepts reviewed patch-generation mixtures without admitting unknown releases', () => {
    const project = manifest(['dev', 'staging', 'prod'], [
      ...sharedApplicationModuleIdentities.map(identity => ({
        ...recorded(identity), generatedBy: '0.11.3'
      })),
    ...
    for (const unreviewed of ['0.10.4', '0.11.4', '0.14.0']) {
