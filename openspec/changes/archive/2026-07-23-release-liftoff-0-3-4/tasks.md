...
- [x] 5.3 Have the managed-mirror owner synchronize or approve `0.3.4`, then confirm mirrored `@latest`, explicit `@0.3.4`, and a clean mirrored installation all identify `0.3.4`.
