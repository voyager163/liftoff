...
- The owner subsequently authorized the minimum Windows CI compatibility repair needed to complete this change, including necessary application/test changes. This exception does not authorize a general audit, disabled tests, weaker assertions, timeout inflation, or npm-account changes.
