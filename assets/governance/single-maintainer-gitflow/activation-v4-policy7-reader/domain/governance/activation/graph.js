...
const terminalVerified = ['verified', 'failed']                                                 ;
const terminalApproved = ['approved', 'failed']                                                 ;
const terminalConditional = ['verified', 'failed', 'inapplicable']                                                 ;

function dep(anyOf                    , description        )                                         {
...
function approval(kind                                        , required         )                                 {
  return { kind, required, envelopeSchemaVersion: approvalEnvelopeSchemaVersion };
}

function rollback(kind                                    , target                , description        )                             {
  return { kind, target, description };
}

const nonGovernanceTaskPhases = new Set        ([
  'seed-valid',
  'seed-verified',
  'seed-archived',
  'committed',
...
export function phaseContractDigest(node                )         {
...
export const currentActivationIdentity                     = createActivationIdentity(canonicalPhaseGraphHash);
