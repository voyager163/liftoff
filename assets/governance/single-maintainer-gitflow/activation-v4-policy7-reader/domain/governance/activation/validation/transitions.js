...
export function validateOperationDestination(value         , path        )                                 {
...
export function validateTransitionOperation(value         , path        )                      {
...
export function validateApprovalEvaluation(value         , path        )                     {
...
export function validateRollbackPlan(value         , path        )                         {
...
export function validateSavedTransitionPlan(value         )                      {
  ...
  const selectionScope = plan.selectionScope === undefined ? undefined :
    enumValue                 (plan.selectionScope, governanceScopeSet, 'transitionPlan.selectionScope');
