...
export function validateFileChanges(value         , path        )                      {
...
export function validateGitInput(value         , path        )                                                       {
...
export function validateEvidenceTransitionIdentity(value         , path        )                             {
