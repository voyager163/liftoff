...
export const liftoffActivationPackageVersion = '0.13.0'         ;
export const liftoffManifestArtifactVersion = 8         ;
export const governanceActivationPolicyVersion = '7'         ;
export const activationContractVersion = 4         ;
export const phaseGraphSchemaVersion = 3         ;
export const activationStateSchemaVersion = 4         ;
export const evidenceHeaderSchemaVersion = 4         ;
export const approvalEnvelopeSchemaVersion = 4         ;
export const compatibilityMetadataSchemaVersion = 5         ;
export const governanceOutputSchemaVersion = 3         ;
...
export function isHistoricalV3ActivationIdentity(value         )                                          {
...
export function resolveActivationCompatibility(
  ...
  if (isHistoricalActivationIdentity(identity)) {
    return { compatible: false, reason: `Historical activation v${identity.activationContractVersion} is diagnostic-only. Run liftoff update --check to inspect an explicitly supported history-preserving v4 successor; preserve original bytes without reset, retagging, or automatic conversion.` };
  }
